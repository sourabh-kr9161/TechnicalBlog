...
<html>
    <head>
        ...
        <title><%= p.getpTitle()  %> Tech Blog by skt</title>
   ...
   body{
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v10.0" nonce="ip3hB6zP"></script>
        ...
        <div class="row my-4">
            <div class="col-md-8 offset-md-2">
             ...
             <div class="form-group">
               <textarea rows=1  class="comment-box form-control" id=p.addCommentId placeholder="Write Your Thoughts.."></textarea>
             </div>
                                                     
    <a href="#!" class="btn btn-primary" class="post-btn" onclick="addComment(<%= p.getPid()%>,<%= user.getId() %>)"  >Post</a> 
          ...
          <form action="EditServlet" method="post" enctype="multipart/form-data" >
              ...
              <table class="table">
                  ...
                  <tr>
                      ...
                      <td> <textarea type="about" class="form-control" name="user_about"> <%= user.getAbout() %>    </textarea>
                  </tr>
                  <tr>
                      <td>Profile pic: </td>
