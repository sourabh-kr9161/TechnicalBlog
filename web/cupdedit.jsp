            ...
            <div class="col-md-8 offset-md-2">
                <div class="card " id="profile-details2">
                    ...
                    <div class="card-footer primary-background">
                        ...
                        <a  href="#!" id="edit-profile-button"  data-toggle="modal" data-target="#exampleModal" class="btn btn-outline-light btn-sm"> Edit</a>
          ...
          <form action="editforpostServlet" method="POST" enctype="multipart/form-data">
              ...
              <table class="table">
                  ...
                  <tr>
                      ...
                      <td> <input type="file" class="form-control" name="user_ppic" value="<%= p.getpPic()  %>">   </td>
                  </tr>
