...
public class CommentDao {
	...
	public static void addComment(CommentDetails model) {
	...
	public static int getCommentId(CommentDetails model) {
	...
	public static ArrayList<CommentDetails> getCommentDetails(int postId, int postPublisherId) {
